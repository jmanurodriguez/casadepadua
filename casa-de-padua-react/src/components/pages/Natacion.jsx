                ...
                <section className="py-16">
                    <div className="container mx-auto px-4 max-w-3xl text-center">
                        <div className="bg-white p-8 rounded-lg shadow-lg animate-on-scroll">
                            <div className="mb-8">
                                <i className="fas fa-person-swimming text-6xl text-casa-purple mb-4"></i>
                                <h2 className="text-3xl font-montserrat font-bold text-casa-purple mb-4">
                                    Página en Construcción
                                </h2>
                                <p className="text-lg text-gray-700">
                                    Estamos trabajando para brindarte toda la información sobre nuestras clases de natación.
