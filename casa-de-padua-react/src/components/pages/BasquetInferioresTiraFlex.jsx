...
export default function InferioresTiraFlex() {
    useScrollAnimation();
                        ...
                        <div className="flex flex-col md:flex-row items-center gap-8 max-w-6xl mx-auto">
                            ...
                            <div className="md:w-2/3 text-center md:text-left">
                                <h1 className="text-4xl md:text-5xl font-montserrat font-bold mb-6">
                                    Basquet Inferiores Tira Flex CASA de Padua
                                </h1>
                        ...
                        <div className="bg-white p-8 rounded-lg shadow-lg animate-on-scroll">
                            <div className="mb-8">
                                ...
                                <p className="text-lg text-gray-700">
                                    Estamos trabajando para brindarte toda la información sobre nuestras clases de telas y acrobacia aérea.
                                    Muy pronto podrás conocer horarios, niveles y más.
                                </p>
                            </div>
