                        ...
                        <div className="flex flex-col md:flex-row items-center gap-8 max-w-6xl mx-auto">
                            ...
                            <div className="md:w-2/3 text-center md:text-left">
                                <h1 className="text-4xl md:text-5xl font-montserrat font-bold mb-6">
                                    Entrenamiento Funcional y GAP CASA de Padua
                                </h1>
                ...
                <section className="py-16">
                    <div className="container mx-auto px-4 max-w-3xl text-center">
                        <div className="bg-white p-8 rounded-lg shadow-lg animate-on-scroll">
                            <div className="mb-8">
                                <i className="fas fa-dumbbell text-6xl text-casa-purple mb-4"></i>
                                <h2 className="text-3xl font-montserrat font-bold text-casa-purple mb-4">
                                    Página en Construcción
                                </h2>
                                <p className="text-lg text-gray-700">
                                    Estamos trabajando para brindarte toda la información sobre nuestras clases de entrenamiento funcional y GAP.
