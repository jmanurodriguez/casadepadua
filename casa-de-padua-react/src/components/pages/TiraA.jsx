...
export default function TiraA() {
    ...
    useEffect(() => {
        ...
        try {
            ...
            const url = `${baseUrl}/api/fixtures/voley/tira-a`;
                        ...
                        <div className="flex flex-col md:flex-row items-center gap-8 max-w-6xl mx-auto">
                            ...
                            <div className="md:w-2/3 text-center md:text-left">
                                <h1 className="text-4xl md:text-5xl font-montserrat font-bold mb-6 animate-fade-in">
                                    Vóley CASA de Padua - Tira A
                                </h1>
                                <p className="text-lg md:text-xl opacity-90 animate-slide-up">
                                    Un equipo con historia y pasión por el vóley. Compitiendo con orgullo en la Tira A.
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="max-w-6xl mx-auto">
                            <div className="flex flex-col md:flex-row gap-12 items-center">
                                <div className="md:w-1/2 animate-on-scroll">
                                    ...
                                    <p className="text-lg text-gray-700 mb-4">
                                        Actualmente, nuestro equipo de Tira A compite en la Liga Metropolitana, enfrentándose a los mejores equipos de la categoría y demostrando partido a partido la calidad de nuestro trabajo.
                                    </p>
                                    <p className="text-lg text-gray-700 mb-4">
                        ...
                        <div className="grid md:grid-cols-2 gap-12">
                            <div className="space-y-6 animate-on-scroll">
                                ...
                                <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300">
                                    <h3 className="text-xl font-bold mb-4 text-casa-purple">Sub-14</h3>
                                    <p className="mb-2"><span className="font-medium">Edades:</span> 12 a 14 años</p>
                                    <p><span className="font-medium">Horarios:</span> Martes y Jueves de 17:00 a 18:30hs</p>
                                </div>
                                <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300">
                                    <h3 className="text-xl font-bold mb-4 text-casa-purple">Sub-16</h3>
                                    <p className="mb-2"><span className="font-medium">Edades:</span> 14 a 16 años</p>
                                    <p><span className="font-medium">Horarios:</span> Lunes y Miércoles de 18:00 a 19:30hs</p>
                                </div>
                                <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300">
                                    <h3 className="text-xl font-bold mb-4 text-casa-purple">Sub-18</h3>
                                    <p className="mb-2"><span className="font-medium">Edades:</span> 16 a 18 años</p>
                            ...
                            <div className="space-y-6 animate-on-scroll">
                                ...
                                <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300">
                                    ...
                                    <p className="mb-2">Prof. María García</p>
                                ...
                                <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300">
                                    <h3 className="text-xl font-bold mb-4 text-casa-purple">Coordinador de Categorías Inferiores</h3>
                                    <p className="mb-2">Prof. Carlos Rodríguez</p>
                                    <p className="flex items-center mt-2">
                                        <i className="fab fa-whatsapp text-green-500 mr-2 text-xl"></i>
