...
export default function PelotaPaleta() {
    useScrollAnimation();
                        ...
                        <div className="bg-white p-8 rounded-lg shadow-lg animate-on-scroll">
                            <div className="mb-8">
                                ...
                                <p className="text-lg text-gray-700">
                                    Estamos trabajando para brindarte toda la información sobre pelota paleta.
                                    Muy pronto podrás conocer horarios, instalaciones y más.
                                </p>
                            </div>
